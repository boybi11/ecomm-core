module.exports = function(apiRoutes, { OrderController }, { AuthMiddleware, OrderMiddleware }) {
    ...
    apiRoutes.post('/backoffice/orders', AuthMiddleware.auth, OrderMiddleware.dataCorrection, OrderController.store);
    apiRoutes.get('/backoffice/orders/:id', AuthMiddleware.auth, OrderController.edit);
    apiRoutes.patch('/backoffice/orders/:id', AuthMiddleware.auth, OrderMiddleware.dataCorrection, OrderController.update);
