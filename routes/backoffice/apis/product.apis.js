module.exports = function(apiRoutes, { ProductController }, { AuthMiddleware, ProductMiddleware, UploadMiddleware }) {
    ...
    apiRoutes.post('/backoffice/products', AuthMiddleware.auth, ProductMiddleware.store, ProductController.store)
    ...
    apiRoutes.patch('/backoffice/products/:id', AuthMiddleware.auth, ProductMiddleware.store, ProductController.update)
